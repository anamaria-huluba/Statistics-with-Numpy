...
# You’re part of an impartial research group that conducts phone surveys prior to local elections. During this election season, the group conducted a survey to determine how many 
# people would vote for Cynthia Ceballos vs. Justin Kerrigan in the mayoral election.
...
# 4. In the real election, 54% of the 10,000 town population voted for Cynthia Ceballos. Your supervisors are concerned because this is a very different outcome than what 
# the poll predicted. They want you to determine if there is something wrong with the poll or if given the sample size, it was an entirely reasonable result.

# Generate a binomial distribution that takes the number of total survey responses, the actual success rate, and the size of the town’s population as its parameters. Then 
# divide the distribution by the number of survey responses. Save your calculation to the variable possible_surveys.
...
# Generate another binomial distribution, but this time, see what would happen if you had instead surveyed 7,000 people. Divide the distribution by the size of the survey 
...
# A much larger sample size is a better representation of what the outcome of the results would be. 

# What advice would you give to your supervisors about predicting results from surveys?
# There are 0% chance of getting a result below 50% when using a more representative sample size, in our case of 7000. This clearly shows that a larger smaple size will 
# result in more accurate predictions and less chances of failure. 
