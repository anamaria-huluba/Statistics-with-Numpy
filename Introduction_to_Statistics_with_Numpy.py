...
# 
# 1. You are working on a team of climate scientists and one of your roles is to take the weekly temperature data and input into NumPy arrays for later analysis. 
...
# 2. Create an array temperatures by importing the data in the CSV temperature_data.csv (CSV based on data from the National Oceanic and Atmospheric Administration)
...
#4. One of the researchers noticed that the sensor had been incorrectly zeroed and all of the recorded temperatures are 3.0 degrees too cold.
...
# 5. Another researcher asked you for the temperature values from Monday. Save them to a new array, monday_temperatures.
...
#6. “Hmmm, interesting” the researcher mumbles, “can you also give me the 6:00 AM data for Thursday and Friday?”
